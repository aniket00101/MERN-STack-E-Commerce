...
const selectedProduct = {
  ...
  originalPrice: 150,
  description:
    "Crafted from premium leather, this jacket blends timeless design with modern edge. Perfect for casual outings or elevated evening looks.",
  brand: "FashionBrand",
...
const ProductDetail = () => {
  ...
  const similarProduct = [
    ...
    { _id: 2, name: "Product 2", price: 110, images: [{ url: "https://picsum.photos/500/500?random=4" }] },
    { _id: 3, name: "Product 3", price: 95, images: [{ url: "https://picsum.photos/500/500?random=5" }] },
    { _id: 4, name: "Product 4", price: 130, images: [{ url: "https://picsum.photos/500/500?random=6" }] },
  ];
              ...
              <button
                ...
                ${
                  isButtonDisabled
                    ...
                    : "bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 hover:scale-[1.02]"
                }`}
              >
