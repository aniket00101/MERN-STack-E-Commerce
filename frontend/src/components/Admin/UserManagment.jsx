    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-slate-900 to-black text-gray-200 px-4 sm:px-6 lg:px-10 py-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl p-6 sm:p-8 mb-12">
          ...
          <h3 className="text-xl sm:text-2xl font-semibold text-white mb-6"> Add New User </h3>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select name="role" value={formData.role} onChange={handleChange} required className="w-full px-4 py-3 bg-white/10 border border-white/20 
            ...
            <div className="sm:col-span-2">
              ...
              <button type="submit" className="w-full bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 text-white py-3 rounded-xl font-semibold hover:scale-[1.02] active:scale-95 transition" >  Add User →  </button>

            </div>
          </form>
        </div>

        <h3 className="text-xl sm:text-2xl font-semibold text-white mb-6"> All Users </h3>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">

          {users.map((user) => (

            <div key={user._id} className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-2xl p-6 shadow-xl hover:bg-white/10 hover:-translate-y-1 transition duration-300">
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <span
                  className={`px-3 py-1 text-xs rounded-full font-semibold ${user.role === "admin" ? "bg-purple-900/40 text-purple-400 border border-purple-700" : "bg-blue-900/40 text-blue-400 border border-blue-700"}`}> {user.role} </span>
              ...
              <div className="mb-4">
                ...
                <select value={user.role} onChange={(e) => handleRoleChange(user._id, e.target.value)} className="w-full px-3 py-2 bg-white/10 border border-white/20 text-white rounded-lg focus:ring-2 focus:ring-purple-500">
