    ...
    <div className='max-w-5xl mx-auto p-6 shadow-md rounded-md'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className='mb-6'>
                ...
                <textarea name="description" value={productData.description} onChange={handleChange} className='w-full border-gray-300 border rounded-md p-2' rows={4} required />
            ...
            <div className='mb-6'>
                ...
                <input type="text" name="sizes" value={productData.sizes.join(", ")} onChange={(e) => setProductData((prev) => ({ ...prev, sizes: e.target.value.split(",").map((size) => size.trim())}))} className='w-full border border-gray-300 rounded-md p-2' required />
             ...
             <div className='mb-6'>
                ...
                <input type="text" name="colors" value={productData.colors.join(", ")} onChange={(e) => setProductData((prev) => ({...prev, colors: e.target.value.split(",").map((color) => color.trim())}))} className='w-full border border-gray-300 rounded-md p-2' required />
