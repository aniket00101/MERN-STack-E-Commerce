    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-gray-950 via-slate-900 to-black relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-20">
                ...
                <img src={register} alt="Register background" className="w-full h-full object-cover blur-lg scale-110" />
            ...
            <div className="relative z-10 w-full max-w-md sm:max-w-lg lg:max-w-4xl lg:flex bg-white/5 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/10 overflow-hidden"> 
                ...
                <div className="w-full lg:w-1/2 p-6 sm:p-8 lg:p-10 flex flex-col justify-center">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h2 className="text-2xl sm:text-3xl font-bold text-white mt-4"> Create Account 🚀 </h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter your email" required className="w-full px-4 py-3 bg-white/10 border border-white/20 text-white placeholder-gray-400 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 
                        ...
                        <div>
                            ...
                            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Create a password" required className="w-full px-4 py-3 bg-white/10 border border-white/20 text-white placeholder-gray-400 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 
                                outline-none transition-all duration-300" />

                        </div>

                        <button type="submit" className="w-full bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 text-white py-3 rounded-xl font-semibold text-lg 
                            shadow-lg hover:scale-105 active:scale-95 transition-all duration-300"> Sign Up → </button>
