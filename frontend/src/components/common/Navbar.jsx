...

            {
                <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-white shadow-lg transform transition-transform duration-300 z-50 ${navDrawerOpen ? "translate-x-0" : "-translate-x-full"}`}>
                    ...
                    <div className='flex justify-end p-4'>
                        ...
                        <button onClick={toogleNavDrawer}> <IoMdClose className='h-6 w-6 text-gray-600' /> </button>
                    ...
                    <div className='p-4'>
                        ...
                        <nav className='space-y-4'>
                            ...
                            <Link to="#" onClick={toogleNavDrawer} className='block text-gray-600 hover:text-black'> Men </Link>

                            <Link to="#" onClick={toogleNavDrawer} className='block text-gray-600 hover:text-black'> Women </Link>

                            <Link to="#" onClick={toogleNavDrawer} className='block text-gray-600 hover:text-black'> Top Wear </Link>

                            <Link to="#" onClick={toogleNavDrawer} className='block text-gray-600 hover:text-black'> Bottom Wear </Link>
